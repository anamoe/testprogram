        ...
        <div class="col-md-12">
            <div class="px-3">
                <div class="card-header row">
                    <div class="col-md-12">
                        <span class="float-left" style="font-size: 24px;">Akun</span>
                        <button class="btn btn-sm btn-rounded btn-primary float-right" data-toggle="modal" data-target="#ModalTambahSS"><i class="fas fa-plus"> </i> Tambah Akun</button>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn-sm btn-warning" data-toggle="modal" data-target="#ModalEditSS" onclick="edit('{{$a->username}}','{{$a->name}}','{{$a->username}}','{{$a->role}}')"><i class="fa fa-edit"></i></a>

                                    <a href="#" onclick="hapus('{{$a->username}}')" type="submit" class="btn-sm btn-danger" data-toggle="modal"><i class="fa fa-trash"></i></a>
